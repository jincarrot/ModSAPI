...
class Entity(object):
    ...
    def applyDamage(self, amount: int, options: 'dict|EntityApplyDamageByProjectileOptions|EntityApplyDamageOptions'=None) -> bool: ...
    def applyImpulse(self, vector: 'Vector3|dict') -> None: ...
    def applyKnockback(self, horizontalForce: 'dict|VectorXZ', verticalStrength: float) -> None: ...
    ...
    def setRotation(self, rotation: 'str|Vector2') -> None: ...
    def teleport(self, location: 'Vector3|dict', teleportOptions: 'dict|TeleportOptions'={}) -> None: ...
    def triggerEvent(self, eventName: str) -> None: ...
    def tryTeleport(self, location: 'dict|Vector3', teleportOptions: 'dict'=None) -> bool: ...
